...
<h1 className="text-4xl font-semibold lg:text-5xl pt-5 tracking-widest uppercase bg-gradient-to-r from-black to-royalblue bg-clip-text text-transparent inline-block">
  Projects
</h1>
      ...
      <div className="py-12 grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12 grid-cols-1">
        {data.map((item) => (
          <a
            ...
            target="_blank"
          >
            <div className="aspect-w-16 aspect-h-8 overflow-hidden rounded-2xl relative">
              <Image
                src={item.imageUrl}
